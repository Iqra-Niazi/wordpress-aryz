<!DOCTYPE html>
<html>
<!-- Mirrored from www.carboncoskins.com/order/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Jan 2023 16:14:31 GMT -->
...
<link rel="stylesheet" id="wpo_min-header-0-css" href="<?php echo get_template_directory_uri(); ?>/assets/css/styles1.css" type="text/css" media="all">
<link rel="stylesheet" id="wpo_min-header-1-css" href="<?php echo get_template_directory_uri(); ?>/assets/css/cf-css.min.css" type="text/css" media="all">
<link rel="stylesheet" id="wpo_min-header-2-css" href="<?php echo get_template_directory_uri(); ?>/assets/css/slick.min.css" type="text/css" media="all">
<link rel="stylesheet" id="wpo_min-header-3-css" href="<?php echo get_template_directory_uri(); ?>/assets/css/styles.min.css" type="text/css" media="all">
<link rel="stylesheet" id="wpo_min-header-4-css" href="<?php echo get_template_directory_uri(); ?>/assets/css/order.min.css" type="text/css" media="all">
<style>:root {
...
<header class="header">
	...
	<input type="text" name="currency" value="USD" class="hide" autocomplete="off">
		<div class="dropdown">
		<div class="parent_drop"><span class="flag_img"><img class="skip-lazy" src="<?php echo get_template_directory_uri(); ?>/assets/images/flags/us.png" alt></span>USD</div>
		<div class="child_drop">
			<ul>
								<li><span class="flag_img"><img class="skip-lazy" src="<?php echo get_template_directory_uri(); ?>/assets/images/flags/au.png" alt></span>AUD</li>
								<li><span class="flag_img"><img class="skip-lazy" src="<?php echo get_template_directory_uri(); ?>/assets/images/flags/us.png" alt></span>USD</li>
								<li><span class="flag_img"><img class="skip-lazy" src="<?php echo get_template_directory_uri(); ?>/assets/images/flags/gb.png" alt></span>GBP</li>
								<li><span class="flag_img"><img class="skip-lazy" src="<?php echo get_template_directory_uri(); ?>/assets/images/flags/eu.png" alt></span>EUR</li>
								<li><span class="flag_img"><img class="skip-lazy" src="<?php echo get_template_directory_uri(); ?>/assets/images/flags/sg.png" alt></span>SGD</li>
								<li><span class="flag_img"><img class="skip-lazy" src="<?php echo get_template_directory_uri(); ?>/assets/images/flags/ca.png" alt></span>CAD</li>
								<li><span class="flag_img"><img class="skip-lazy" src="<?php echo get_template_directory_uri(); ?>/assets/images/flags/no.png" alt></span>NOK</li>
							</ul>
		...
		<div class="hidden_menu">
			<div class="-scrollbar menu_scroll">
				<div class="container hidden_menu__container">
					<ul class="menu__list -opacity_hover"><li><a href="index.html">Design My Own</a></li>
...
<li><a href="../faq/index.html">FAQ</a></li>
						...
						<div class="social_icon__list"><a title="Tiktok" target="_blank" href="https://www.tiktok.com/@carboncoskins" class="img social_icon -opacity_hover"><noscript><img src="<?php echo get_template_directory_uri(); ?>/assets/images/2021/06/social_tiktok.svg" alt="Tiktok"></noscript><img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" alt="Tiktok" data-src="/wp-content/uploads/2021/06/social_tiktok.svg" class=" lazyload"></a>
<a title="Facebook" target="_blank" href="https://www.facebook.com/carboncoskins" class="img social_icon -opacity_hover"><noscript><img src="<?php echo get_template_directory_uri(); ?>/assets/images/2021/06/social_fb.svg" alt="Facebook"></noscript><img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" alt="Facebook" data-src="/wp-content/uploads/2021/06/social_fb.svg" class=" lazyload"></a>
<a title="Instagram" target="_blank" href="https://www.instagram.com/carboncoskins/" class="img social_icon -opacity_hover"><noscript><img src="<?php echo get_template_directory_uri(); ?>/assets/images/2021/06/social_insta.svg" alt="Instagram"></noscript><img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" alt="Instagram" data-src="/wp-content/uploads/2021/06/social_insta.svg" class=" lazyload"></a>
...
<main><section class="card__pre_view-section">
	<div class="container">
	...
	<div class="mob_content">
		<header class="card__settings_header -grey_border-bottom" id="swiper_close">
			<div class="card__settings_container">
				...
				<a href="../index.html" class="white_button -black -gray">
					Need help?
				</a>
			</div>
		</header>
				...
				<div class="card__settings_container card_settings_tab_container">
					...
					<div class="card__settings_item active first_chooze">
						<form autocomplete="off" class="card_settings_cardinfo_form">
							...
							<div class="input_box input_box_carddropdown card_settings_cardnumberon_input_box">
								...
								<div class="dropdown">
									<div class="parent_drop"><span class="flag_img card_img"><img class="skip-lazy" src="<?php echo get_template_directory_uri(); ?>/assets/images/card_front.svg" alt></span>Front</div>
									<div class="child_drop">
										<ul>
											<li class="active"><span class="flag_img card_img"><img class="skip-lazy" src="<?php echo get_template_directory_uri(); ?>/assets/images/card_front.svg" alt></span>Front</li>
											<li><span class="flag_img card_img"><img class="skip-lazy" src="<?php echo get_template_directory_uri(); ?>/assets/images/card_back.svg" alt></span>Back</li>
										</ul>
									</div>
								</div>
							</div>
					...
					<div class="card__settings_item">
						<form autocomplete="off">
							<input type="hidden" name="card_template" value="simple">
							<input type="hidden" name="card_template_title" value="Carbon Skin">
									...
									<div class="radio_list">
										<div class="radio_box">
												...
												<label for="color_radio_black">
													<div class="img"><img class="skip-lazy" src="<?php echo get_template_directory_uri(); ?>/assets/images/card-circles/black.png" alt></div>
												...
												<label for="color_radio_gold">
													<div class="img"><img class="skip-lazy" src="<?php echo get_template_directory_uri(); ?>/assets/images/card-circles/gold.png" alt></div>
												...
												<label for="color_radio_silver">
													<div class="img"><img class="skip-lazy" src="<?php echo get_template_directory_uri(); ?>/assets/images/card-circles/silver.png" alt></div>
												...
												<label for="color_radio_rose">
													<div class="img"><img class="skip-lazy" src="<?php echo get_template_directory_uri(); ?>/assets/images/card-circles/rose.png" alt></div>
												...
												<label for="color_radio_blackgold">
													<div class="img"><img class="skip-lazy" src="<?php echo get_template_directory_uri(); ?>/assets/images/card-circles/blackgold.png" alt></div>
												...
												<label for="color_radio_rainbow">
													<div class="img"><img class="skip-lazy" src="<?php echo get_template_directory_uri(); ?>/assets/images/card-circles/rainbow.png" alt></div>
								...
								<div class="input_box">
									...
									<div class="check_list check_list_border"><div class="radio_box">
											...
											<label for="checkbox_frame_1">
												<div class="border_img"><noscript><img class="border_img_icon" src="<?php echo get_template_directory_uri(); ?>/assets/images/cards/background-border-1-icon.svg"></noscript><img class="border_img_icon lazyload" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" data-src="<?php echo get_template_directory_uri(); ?>/assets/images/cards/background-border-1-icon.svg"></div>
											...
											<label for="checkbox_frame_2">
												<div class="border_img"><noscript><img class="border_img_icon" src="<?php echo get_template_directory_uri(); ?>/assets/images/cards/background-border-2-iconc4ca.svg?1"></noscript><img class="border_img_icon lazyload" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" data-src="<?php echo get_template_directory_uri(); ?>/assets/images/cards/background-border-2-iconc4ca.svg?1"></div>
												<span class="price_block_container"><span class="price_plus">+</span><span class="price_block"><span class="currency_prefix"></span><span class="price_value">0</span><span class="currency_suffix"></span></span></span>
											</label>
										</div></div>
								</div>
...
<div class="modal__wrapper">
	...
	<div class="modal_content payment_modal">
		...
		<form id="payment-form">
			...
			<div id="card-element" class="StripeElement StripeElement--empty"><div class="__PrivateStripeElement" style="margin: 0px !important; padding: 0px !important; border: none !important; display: block !important; background: transparent !important; position: relative !important; opacity: 1 !important;"><iframe name="__privateStripeFrame34310" frameborder="0" allowtransparency="true" scrolling="no" role="presentation" allow="payment *" src="https://js.stripe.com/v3/elements-inner-card-1847ac16465e62d7308bdd6092bc2c56.html#wait=false&amp;mids[guid]=d8407161-196f-4615-b565-abe3e782283fed6e57&amp;mids[muid]=d850f0b1-ec08-45f5-9b42-44dc8699af414fc8df&amp;mids[sid]=182bd158-9ad7-4119-8985-64ade3a9021b61b53a&amp;hidePostalCode=true&amp;style[base][color]=%2332325d&amp;style[base][fontFamily]=Arial%2C+sans-serif&amp;style[base][fontSmoothing]=antialiased&amp;style[base][fontSize]=16px&amp;style[base][::placeholder][color]=%2332325d&amp;style[invalid][fontFamily]=Arial%2C+sans-serif&amp;style[invalid][color]=%23fa755a&amp;style[invalid][iconColor]=%23fa755a&amp;rtl=false&amp;componentName=card&amp;keyMode=live&amp;apiKey=pk_live_51Hw4iYJFAQeMdV8rwLplq122ZKq8fiL6h201DZRxedJWbtdwY4CEdcW0ZOkw8oPea0qNiY2rOnnsq4HDbWgVv9Ko00CRHiB8UX&amp;referrer=https%3A%2F%2Fwww.carboncoskins.com%2Forder%2F&amp;controllerId=__privateStripeController3431" title="Secure card payment input frame" style="border: none !important; margin: 0px !important; padding: 0px !important; width: 1px !important; min-width: 100% !important; overflow: hidden !important; display: block !important; user-select: none !important; transform: translate(0px) !important; color-scheme: light only !important; height: 19.2px;"></iframe><input class="__PrivateStripeElement-input" aria-hidden="true" aria-label=" " autocomplete="false" maxlength="1" style="border: none !important; display: block !important; position: absolute !important; height: 1px !important; top: -1px !important; left: 0px !important; padding: 0px !important; margin: 0px !important; width: 100% !important; opacity: 0 !important; background: transparent !important; pointer-events: none !important; font-size: 16px !important;"></div></div>
			<button id="submit">
	...
	<div class="modal_content email_submitting">
		...
		<div class="payment_verify_content">
			...
			<noscript><img class="payment_verify_preloader" src="<?php echo get_template_directory_uri(); ?>/assets/images/circle-preloader.svg"></noscript><img class="payment_verify_preloader lazyload" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" data-src="<?php echo get_template_directory_uri(); ?>/assets/images/circle-preloader.svg">
	...
	<div class="modal_content payment_success_modal">
		<div class="close_modal"></div>
		<div class="top_modal_row">
			<img class="skip-lazy" src="<?php echo get_template_directory_uri(); ?>/assets/images/order_success_icon.svg" alt>
		</div>
		<div class="top_modal_row">
		...
		<div class="tutorial_modal_content">
			<div class="tutorial_modal_slider">
				<div class="tutorial_modal_slide">
					...
					<div class="tutorial_modal_video">
						<div class="tutorial_modal_video_img">
							<img class="skip-lazy" src="<?php echo get_template_directory_uri(); ?>/assets/video/order-tutorial/step_0c4ca.jpg?1">
						</div>
					</div>
				...
				<div class="tutorial_modal_slide">
					...
					<div class="tutorial_modal_video">
						<video class="tutorial_modal_video_desktop" muted loop playsinline src="<?php echo get_template_directory_uri(); ?>/assets/video/order-tutorial/desktop/step_1.mp4" poster="<?php echo get_template_directory_uri(); ?>/assets/video/order-tutorial/desktop/step_1.jpg"></video>
						<video class="tutorial_modal_video_mobile" muted loop playsinline src="<?php echo get_template_directory_uri(); ?>/assets/video/order-tutorial/mobile/step_1.mp4" poster="<?php echo get_template_directory_uri(); ?>/assets/video/order-tutorial/mobile/step_1.jpg"></video>
					</div>
					<div class="tutorial_modal_text">
				...
				<div class="tutorial_modal_slide">
					...
					<div class="tutorial_modal_video">
						<video class="tutorial_modal_video_desktop" muted loop playsinline src="<?php echo get_template_directory_uri(); ?>/assets/video/order-tutorial/desktop/step_2.mp4" poster="<?php echo get_template_directory_uri(); ?>/assets/video/order-tutorial/desktop/step_2.jpg"></video>
						<video class="tutorial_modal_video_mobile" muted loop playsinline src="<?php echo get_template_directory_uri(); ?>/assets/video/order-tutorial/mobile/step_2.mp4" poster="<?php echo get_template_directory_uri(); ?>/assets/video/order-tutorial/mobile/step_2.jpg"></video>
					</div>
					<div class="tutorial_modal_text">
				...
				<div class="tutorial_modal_slide">
					...
					<div class="tutorial_modal_video">
						<video class="tutorial_modal_video_desktop" muted loop playsinline src="<?php echo get_template_directory_uri(); ?>/assets/video/order-tutorial/desktop/step_3c4ca.mp4?1" poster="<?php echo get_template_directory_uri(); ?>/assets/video/order-tutorial/desktop/step_3.jpg"></video>
						<video class="tutorial_modal_video_mobile" muted loop playsinline src="<?php echo get_template_directory_uri(); ?>/assets/video/order-tutorial/mobile/step_3c4ca.mp4?1" poster="<?php echo get_template_directory_uri(); ?>/assets/video/order-tutorial/mobile/step_3.jpg"></video>
					</div>
					<div class="tutorial_modal_text">
				...
				<div class="tutorial_modal_slide">
					...
					<div class="tutorial_modal_video">
						<video class="tutorial_modal_video_desktop" muted loop playsinline src="<?php echo get_template_directory_uri(); ?>/assets/video/order-tutorial/desktop/step_4.mp4" poster="<?php echo get_template_directory_uri(); ?>/assets/video/order-tutorial/desktop/step_4.jpg"></video>
						<video class="tutorial_modal_video_mobile" muted loop playsinline src="<?php echo get_template_directory_uri(); ?>/assets/video/order-tutorial/mobile/step_4.mp4" poster="<?php echo get_template_directory_uri(); ?>/assets/video/order-tutorial/mobile/step_4.jpg"></video>
					</div>
					<div class="tutorial_modal_text">
				...
				<div class="tutorial_modal_slide">
					...
					<div class="tutorial_modal_video">
						<video class="tutorial_modal_video_desktop" muted loop playsinline src="<?php echo get_template_directory_uri(); ?>/assets/video/order-tutorial/desktop/step_5.mp4" poster="<?php echo get_template_directory_uri(); ?>/assets/video/order-tutorial/desktop/step_5.jpg"></video>
						<video class="tutorial_modal_video_mobile" muted loop playsinline src="<?php echo get_template_directory_uri(); ?>/assets/video/order-tutorial/mobile/step_5.mp4" poster="<?php echo get_template_directory_uri(); ?>/assets/video/order-tutorial/mobile/step_5.jpg"></video>
					</div>
					<div class="tutorial_modal_text">
...
<div class="tutorial_fixed_icon">
	<a href="#" class="tutorial_fixed_icon_link"><img class="skip-lazy" src="<?php echo get_template_directory_uri(); ?>/assets/images/icon-question.svg"><span>Help</span></a>
</div>
<script>
...
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/assets/js/jquery-3.4.1v.min.js" id="wpo_min-footer-0-js"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/assets/js/slick.min.js" id="wpo_min-footer-1-js"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/assets/js/swipe.min.js" id="wpo_min-footer-2-js"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/assets/js/mask.min.js" id="wpo_min-footer-3-js"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/assets/js/fabric.min.js" id="wpo_min-footer-4-js"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/assets/js/cookie.min.js" id="wpo_min-footer-5-js"></script>
<script type="text/javascript" src="https://js.stripe.com/v3/" id="stripe-js"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/assets/js/script.min.js" id="wpo_min-footer-7-js"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/assets/js/order.min.js" id="wpo_min-footer-8-js"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/assets/js/googlepay.min.js" id="wpo_min-footer-9-js"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/assets/js/lazysize.min.js" id="wpo_min-footer-10-js"></script>
<script type="text/javascript" src="http://code.jivosite.com/widget/l0O7ge6el9" id="jivosite_widget_code-js"></script>
</body>

<!-- Mirrored from www.carboncoskins.com/order/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Jan 2023 16:15:40 GMT -->
</html>

<!-- Cached by WP-Optimize (gzip) - https://getwpo.com - Last modified: Tue, 10 Jan 2023 11:01:12 GMT -->
